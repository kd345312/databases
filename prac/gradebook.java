...
class gradebook {
  ...
  public static void main (String args []) 
    ...
    do {
      ...
      switch (ch) {
        case '1' : g1.add_player(conn);
                   break;
        case '2' : g1.add_hero(conn);
                   break;
        case '3' : g1.add_game(conn);
                   break;
        case '4': g1.add_winner(conn);
                   break;
        case '5': g1.add_loser(conn);
                   break;
        case '6': g1.print_heros(conn);
                   break;
        case '7': g1.delete_hero(conn);
                   break;
        case '8': g1.modify_ability(conn);
                   break;
        case 'q' : done = true;
                   break;
